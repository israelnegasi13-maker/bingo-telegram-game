          ...
          if (uId === userId) {
            ...
            if (socket) {
              socket.emit('gameOver', {
                ...
                winningPattern: [] // Add empty pattern for consistency
              });
              socket.emit('balanceUpdate', user.balance);
            }
          }
        ...
        setTimeout(async () => {
          try {
              ...
              { 
                ...
                $push: { 
                  gameHistory: {
                    ...
                    winningPattern: bingoCheck.pattern // Store winning pattern
                  }
                }
              },
              { new: true }
            ...
            const gameOverData = {
              ...
              contributionPerPlayer: contributionPerPlayer,
              houseEarnings: houseEarnings,
              winningPattern: bingoCheck.pattern // Add winning pattern for visualization
            };
