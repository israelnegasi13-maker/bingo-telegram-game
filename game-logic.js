...
async function endGameWithNoWinner(room) {
  ...
  function setupSocketHandlers() {
    io.on('connection', (socket) => {
      ...
      // ========== FIXED: CLAIM BINGO WITH DOUBLE PRIZE PROTECTION AND WINNING PATTERN ==========
      socket.on('claimBingo', async (data, callback) => {
        ...
        try {
          ...
          console.log(`   Winning pattern: ${bingoCheck.pattern}`);
          ...
          setTimeout(async () => {
            try {
              ...
              console.log(`📊 Winning pattern sent to players: ${bingoCheck.pattern}`);
