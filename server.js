// server.js - BINGO ELITE - TELEGRAM MINI APP - MAIN FILE
...
// Import routes
const setupRoutes = require('./server1');
...
// ========== EXPORT SHARED VARIABLES FOR ROUTES ==========
const sharedState = {
  io,
  User,
  Room,
...
// ========== EXPORT SHARED HELPER FUNCTIONS FOR ROUTES ==========
sharedState.getConnectedUsers = getConnectedUsers;
sharedState.getOnlinePlayersInRoom = getOnlinePlayersInRoom;
sharedState.broadcastTakenBoxes = broadcastTakenBoxes;
sharedState.startGameTimer = startGameTimer;
sharedState.broadcastRoomStatus = broadcastRoomStatus;
sharedState.updateAdminPanel = updateAdminPanel;

// ========== SETUP ROUTES FROM server1.js ==========
setupRoutes(app, sharedState);
